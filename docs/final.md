...
The images above show the background the various steps in the background removal pipeline and there corresponding Minecraft structure as described below.  </br>
